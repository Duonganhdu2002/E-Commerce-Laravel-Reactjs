                ...
                {data &&
                    ...
                    data.map((product, index) => (
                        <Link key={index} to={`/product/${product.product_id}`}>
                            <section className="p-2 transform duration-500 w-1/2 md:w-1/3 xl:w-1/4 2xl:w-1/5 float-left cursor-pointer">
                                <div className="flex flex-col items-center bg-[#475877]/10 rounded-xl text-center py-6 px-4 mt-4">
