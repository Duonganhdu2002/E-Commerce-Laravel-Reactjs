      ...
      <div className='w-[95%] md:w-[90%] lg:w-[80%]'>
        {
          data && data.length > 0 && data.map((product, index) => (
            <section key={index} className="p-5 py-10 bg-purple-50 text-center transform duration-500 hover:-translate-y-2 cursor-pointer w-1/2 h-[500px] float-left">
              <img className=' w-[200px] h-[200px] object-cover' src={`../../../../src/assets/image/${product.images[0]}`} alt="" />
              ...
              {/* <button className="p-1 px-4 bg-purple-500 text-white rounded-md hover:bg-purple-600">Add To Cart</button> */}
              {/* <button className="p-1 px-4 bg-purple-500 text-white rounded-md hover:bg-purple-600">Buy now</button> */}
            </section>
          ))
        }
