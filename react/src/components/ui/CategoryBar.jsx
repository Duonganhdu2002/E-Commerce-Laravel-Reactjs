                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {
                                    dataFilter && dataFilter.length > 0 && dataFilter.map((products, index) => (
                                        <Link key={index} to={`/product/${products.product_id}`}>
                                            ...
                                            {products.images?.[0] ? (
                                                <img
                                                    className=" h-[200px] md:h-[220px] md:w-[220px] lg:h-[280px] lg:w-[280px] xl:h-[320px] xl:w-[320px] object-cover rounded-t-xl"
                                                    src={`../../../src/assets/image/${products.images[0]}`}
                                                    alt="Product"
                                                />
                                    ) : (
                                        <img
                                            className=" h-[200px] w-full md:h-[220px] md:w-[220px] lg:h-[280px] lg:w-[280px] xl:h-[320px] xl:w-[320px] object-cover rounded-t-xl"
