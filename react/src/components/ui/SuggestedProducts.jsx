...
export default function SuggestedProducts() {
    return (
        <div className="flex flex-col items-center mt-8 px-0 2xl:px-[10%] xl:px-[10%] lg:px-[10%] md:px-[5%] sm:px-4">
            <div className=" flex py-2 w-full justify-center border-[#1e293b] border-y-2 bg-[#4d75b66c]/10">SUGGESTED PRODUCTS</div>
            ...
            <div className=" text-lg text-slate-800/70 my-8">
                <p> You&lsquo;ve reached the last page, please go back ^.^</p>
            </div>
        </div>
    );
}
