              ...
              <div className="flex items-center w-96">
                <div>
                  <div className="flex items-center">
                    <img className="h-30 w-20 mr-30" src={logo} alt="icon" />
                    <p className=" ml-10 font-bold text-xl">COMPANY</p>
                  </div>
                  <div className=" mt-8">
                    <p>
                      Online Shopping BD has never been easier. Company is best
                      online shopping store in Biet Nam that features 20+
                      million products at affordable prices. As vietnam's online
                      shopping landscape is expanding every year online shopping
                      in dhaka, chittagong, khulna, sylhet and other big cities
                      are also gaining momentum. Company is among best websites
                      for online shopping in Viet Nam.
                    </p>
                  </div>
                  <div className=" mt-8 flex items-center">
                    <img className="h-6 w-6 mr-4" src={map_black} alt="icon" />
                    <p>
                      1080 Nguyen Trong Tuyen, Phu Nhuan, Ho Chi Minh City, Viet
                      Nam
                    </p>
                  </div>
