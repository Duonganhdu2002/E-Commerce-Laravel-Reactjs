...
const AllRating = ({ seller_id }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let res = await getProductListRating(seller_id, "", page);
...
const FiveRating = ({ seller_id }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let res = await getProductListRating(seller_id, 5, page);
                setData(res.data.data);
                setDataFull(res.data);
            } catch (error) {
                console.error(error)
...
const FourRating = ({ seller_id }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let res = await getProductListRating(seller_id, 4, page);
                setData(res.data.data);
                setDataFull(res.data);
            } catch (error) {
                console.error(error)
...
const ThreeRating = ({ seller_id }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let res = await getProductListRating(seller_id, 3, page);
                setData(res.data.data);
                setDataFull(res.data);
            } catch (error) {
                console.error(error)
...
const TowRating = ({ seller_id }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let res = await getProductListRating(seller_id, 2, page);
                setData(res.data.data);
                setDataFull(res.data);
            } catch (error) {
                console.error(error)
...
const OneRating = ({ seller_id }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let res = await getProductListRating(seller_id, 1, page);
                setData(res.data.data);
                setDataFull(res.data);
            } catch (error) {
                console.error(error)
    ...
    const TABS = [
        {
            label: "All",
            value: "all",
            desc: <AllRating seller_id={seller_id} />
        },
        {
            label: "5 Stars",
            value: "5 Stars",
            desc: <FiveRating seller_id={seller_id} />
        },
        {
            label: "4 Stars",
            value: "4 Stars",
            desc: <FourRating seller_id={seller_id} />
        },
        {
            label: "3 Stars",
            value: "3 Stars",
            desc: <ThreeRating seller_id={seller_id} />
        },
        {
            label: "2 Stars",
            value: "2 Stars",
            desc: <TowRating seller_id={seller_id} />
        },
        {
            label: "1 Stars",
            value: "1 Stars",
            desc: <OneRating seller_id={seller_id} />
        },
    ];
