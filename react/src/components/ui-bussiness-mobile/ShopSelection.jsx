...
const ShopSelection = () => {
    const shopData = [
        { id: 1, icon: Image, status: 'In progress' },
    ...
    return (
        <div className='shadow-lg shadow-blue-gray-900/15 h-auto mt-4'>
            <div className='grid grid-cols-3 gap-2 pt-0 p-2'>
                {shopData.map(({ id, icon, status }) => (
                    <div key={id} className='cursor-pointer w-full py-4 bg-opacity-50 bg-gray-200 rounded-md flex flex-col justify-center items-center'>
